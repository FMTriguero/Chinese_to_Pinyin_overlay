...
from ocr.detector.utils import gen_anchor, bbox_transfor_inv, clip_box, filter_bbox, nms, \
    TextProposalConnectorOriented, softmax
...
class Detector:
    ...
    def __init__(self):
        ...
        self.session = rt.InferenceSession(os.path.join("data", "cptn.onnx"), session_opts)
